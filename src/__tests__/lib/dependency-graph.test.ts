...
describe("buildDependencyGraph", () => {
  ...
  test("creates edges for dependencies", () => {
    const prd = createPrd([
      createTask({ id: "task-1", title: "Task 1" }),
      createTask({ dependsOn: ["task-1"], id: "task-2", title: "Task 2" }),
    ]);
    const graph = buildDependencyGraph(prd);
...
describe("validateDependencies", () => {
  ...
  test("detects missing dependency", () => {
    const prd = createPrd([
      createTask({ dependsOn: ["non-existent"], id: "task-1", title: "Task 1" }),
    ]);
    const result = validateDependencies(prd);
  ...
  test("detects self-reference", () => {
    const prd = createPrd([createTask({ dependsOn: ["task-1"], id: "task-1", title: "Task 1" })]);
    const result = validateDependencies(prd);
  ...
  test("detects missing id when task has dependencies", () => {
    const prd = createPrd([
      createTask({ id: "task-1", title: "Task 1" }),
      createTask({ dependsOn: ["task-1"], title: "Task 2" }),
    ]);
    const result = validateDependencies(prd);
...
describe("detectCycles", () => {
  ...
  test("returns no cycle for linear dependencies", () => {
    const prd = createPrd([
      createTask({ id: "task-1", title: "Task 1" }),
      createTask({ dependsOn: ["task-1"], id: "task-2", title: "Task 2" }),
      createTask({ dependsOn: ["task-2"], id: "task-3", title: "Task 3" }),
    ]);
    const result = detectCycles(prd);
  ...
  test("detects direct cycle between two tasks", () => {
    const prd = createPrd([
      createTask({ dependsOn: ["task-2"], id: "task-1", title: "Task 1" }),
      createTask({ dependsOn: ["task-1"], id: "task-2", title: "Task 2" }),
    ]);
    const result = detectCycles(prd);
  ...
  test("detects indirect cycle through multiple tasks", () => {
    const prd = createPrd([
      createTask({ dependsOn: ["task-3"], id: "task-1", title: "Task 1" }),
      createTask({ dependsOn: ["task-1"], id: "task-2", title: "Task 2" }),
      createTask({ dependsOn: ["task-2"], id: "task-3", title: "Task 3" }),
    ]);
    const result = detectCycles(prd);
  ...
  test("returns no cycle for diamond dependency pattern", () => {
    const prd = createPrd([
      createTask({ id: "task-1", title: "Task 1" }),
      createTask({ dependsOn: ["task-1"], id: "task-2", title: "Task 2" }),
      createTask({ dependsOn: ["task-1"], id: "task-3", title: "Task 3" }),
      createTask({ dependsOn: ["task-2", "task-3"], id: "task-4", title: "Task 4" }),
    ]);
    const result = detectCycles(prd);
...
describe("getReadyTasks", () => {
  ...
  test("excludes completed tasks", () => {
    const prd = createPrd([
      createTask({ done: true, id: "task-1", title: "Task 1" }),
      createTask({ id: "task-2", title: "Task 2" }),
    ]);
    const result = getReadyTasks(prd);
...
describe("getBlockedTasks", () => {
  ...
  test("excludes completed tasks from blocked list", () => {
    const prd = createPrd([
      createTask({ id: "task-1", title: "Task 1" }),
      createTask({ dependsOn: ["task-1"], done: true, id: "task-2", title: "Task 2" }),
    ]);
    const result = getBlockedTasks(prd);
...
describe("getDependencies", () => {
  ...
  test("returns dependencies for task", () => {
    const prd = createPrd([
      createTask({ id: "task-1", title: "Task 1" }),
      createTask({ id: "task-2", title: "Task 2" }),
      createTask({ dependsOn: ["task-1", "task-2"], id: "task-3", title: "Task 3" }),
    ]);
...
describe("getNextReadyTask", () => {
  ...
  test("returns null when all tasks are done", () => {
    const prd = createPrd([createTask({ done: true, id: "task-1", title: "Task 1" })]);
    const result = getNextReadyTask(prd);
  ...
  test("returns highest priority ready task", () => {
    const prd = createPrd([
      createTask({ id: "task-1", priority: 2, title: "Task 1" }),
      createTask({ id: "task-2", priority: 1, title: "Task 2" }),
    ]);
    const result = getNextReadyTask(prd);
  ...
  test("skips blocked tasks", () => {
    const prd = createPrd([
      createTask({ id: "task-1", priority: 2, title: "Task 1" }),
      createTask({ dependsOn: ["task-1"], id: "task-2", priority: 1, title: "Task 2" }),
    ]);
    const result = getNextReadyTask(prd);
...
describe("getParallelExecutionGroups", () => {
  ...
  test("sorts within group by priority", () => {
    const prd = createPrd([
      createTask({ id: "task-1", priority: 3, title: "Task 1" }),
      createTask({ id: "task-2", priority: 1, title: "Task 2" }),
      createTask({ id: "task-3", priority: 2, title: "Task 3" }),
    ]);
    const result = getParallelExecutionGroups(prd);
